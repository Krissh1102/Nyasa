  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.add_rounded), onPressed: () => _openForm()),
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: AppSearchField(hint: 'Search products', onChanged: (v) => setState(() => _query = v)),
          ),
          SizedBox(
            height: 40,
            child: ListView(
              ...
              Container(
                ...
                child: product.imageUrl != null
                    ? Image.network(
                        product.imageUrl!,
                        fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => const Icon(Icons.shopping_bag_outlined, color: AppColors.inkFaint),
                      )
                    : const Icon(Icons.shopping_bag_outlined, color: AppColors.inkFaint),
              ),
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        if (!product.isActive)
                          Container(
                            ...
                            child: const Text('Inactive', style: TextStyle(fontSize: 9.5, color: AppColors.inkFaint, fontWeight: FontWeight.w700)),
                          ),
                      ],
                    ),
                    const SizedBox(height: 3),
                    Text(product.categoryName, style: const TextStyle(fontSize: 11.5, color: AppColors.inkFaint)),
                    ...
                    Row(
                      children: [
                        ...
                        Icon(
                          product.isOutOfStock ? Icons.error_rounded : (product.isLowStock ? Icons.warning_amber_rounded : Icons.check_circle_rounded),
                          size: 13,
                          color: product.isOutOfStock ? AppColors.danger : (product.isLowStock ? AppColors.warning : const Color(0xFF15803D)),
                        ),
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            color: product.isOutOfStock ? AppColors.danger : (product.isLowStock ? AppColors.warning : AppColors.inkSoft),
                          ),
                        ),
                      ],
                    ),
